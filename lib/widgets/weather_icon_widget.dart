...
class WeatherIconWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final sunriseTime = DateTime(currentTime.year, currentTime.month, currentTime.day, 6, 0);
    final sunsetTime = DateTime(currentTime.year, currentTime.month, currentTime.day, 22, 0);
    ...
    switch (value) {
      ...
      default:
        ...
        } else if (value.toDouble() > 2 && currentTime.isAfter(sunriseTime) && currentTime.isBefore(sunsetTime)) {
          return Image.asset('assets/images/Sun cloud mid rain.png');
        } else {
          return Image.asset('assets/images/moonn.png');
        }
